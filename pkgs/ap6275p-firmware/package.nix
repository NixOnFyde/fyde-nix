...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    runHook preInstall
    mkdir -p $out/lib/firmware/ap6275p $out/lib/firmware/brcm
    ...
    ln -s ../ap6275p/fw_bcm43752a2_pcie_ag.bin $out/lib/firmware/brcm/brcmfmac43752-pcie.bin
    ln -s ../ap6275p/nvram_AP6275P.txt $out/lib/firmware/brcm/brcmfmac43752-pcie.txt
    ln -s ../ap6275p/clm_bcm43752a2_pcie_ag.blob $out/lib/firmware/brcm/brcmfmac43752-pcie.clm_blob
    runHook postInstall
  '';
